...
class Full_Test:
    def __init__(self):
        ...
        self.replace_abbreviation = replace_acronyms(
            self.big_counter, prefix="ABBR", preprocessed=False
        )
    ...
    def full_run(self, text):
        ...
        replaced_abbrv_doc = self.replace_abbreviation(titlecaps_doc, counter)
